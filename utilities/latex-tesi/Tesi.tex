...
\begin{itemize}
\item Validità di CERT.DPpb.SIG: l'implementazione prevede un controllo sul certificato CERT.DPpb.SIG mediante la chiave pubblica del CI.
...
\item Validità di euiccCancelSessionSignature: l'implementazione prevede un controllo della signature contenuta nel messaggio mediante la chiave pubblica associata al certificato CERT.EUICC.SIG.
\end{itemize}
Tuttavia, manca un controllo sull'OID.
