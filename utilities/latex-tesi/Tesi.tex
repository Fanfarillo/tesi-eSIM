...
\textbf{Abstract}
\end{center}
Questo è un abstract che riassume brevemente il contenuto del tuo documento.
\end{titlepage}
...
\textit{EUICCInfo1 ::= [32] SEQUENCE \{ -- Tag 'BF20'}

\hspace{0.75cm} \textit{svn [2] VersionType, -- GSMA SGP.22 version supported (SVN)}
...
\hspace{0.75cm} \textit{transactionId [0] TransactionId, -- The Transaction ID generated by the RSP Server}

\hspace{0.75cm} \textit{euiccChallenge [1] Octet16, -- The eUICC Challenge}

\hspace{0.75cm} \textit{serverAddress [3] UTF8String, -- The RSP Server address}

\hspace{0.75cm} \textit{serverChallenge [4] Octet16, -- The RSP Server Challenge}
...
\textit{AuthenticateServerResponse ::= [56] CHOICE \{ -- Tag 'BF38'}
...
\hspace{0.75cm} \textit{euiccSigned1 EuiccSigned1, -- Signed information}

\hspace{0.75cm} \textit{euiccSignature1 [APPLICAION 55] OCTET STRING, -- EUICC\_Sign1, tag 5F37}

\hspace{0.75cm} \textit{euiccCertificate Certificate, -- CERT.EUICC.ECDSA signed by the EUM}

\hspace{0.75cm} \textit{eumCertificate Certificate -- CERT.EUM.ECDSA signed by the CI}
...
\textit{EuiccInfo2 ::= [34] SEQUENCE \{ -- Tag 'BF22'}

\hspace{0.75cm} \textit{profileVersion [1] VersionType, -- SIMAlliace Profile package version supported}

\hspace{0.75cm} \textit{svn [2] VersionType, -- eUICC Firmware version}

\hspace{0.75cm} \textit{euiccFirmwareVer [3] VersionType, -- eUICC Firmware version}

\hspace{0.75cm} \textit{extCardResource [4] OCTET STRING, -- Extended Card Resource Information}
...
\hspace{0.75cm} \textit{forbiddenProfilePolicyRules [25] PprIds OPTIONAL, -- Tag '99'}

\hspace{0.75cm} \textit{ppVersion VersionType, -- Protection Profile version}
...
\hspace{0.75cm} \textit{deviceInfo DeviceInfo -- The Device information}
...
\textit{StoreMetadataRequest ::= [37] SEQUENCE \{ -- Tag 'BF25'}

\hspace{0.75cm} \textit{iccid Iccid,}

\hspace{0.75cm} \textit{serviceProviderName [17] UTF8String (SIZE(0..32)), -- Tag '91'}

\hspace{0.75cm} \textit{profileName [18] UTF8String (SIZE(0..64)), -- Tag '92'}

\hspace{0.75cm} \textit{iconType [19] IconType OPTIONAL, -- Tag '93' (JPG or PNG)}

\hspace{0.75cm} \textit{icon [20] OCTET STRING (SIZE(0..1024)), -- Tag '94' (Data of the icon}

\hspace{0.75cm} \textit{profileClass [21] ProfileClass DEFAULT operational, -- Tag '95'}

\hspace{0.75cm} \textit{notifConfig [22] SEQUENCE OF NotificationConfigurationInformation OPTIONAL,}

\hspace{0.75cm} \textit{profileOwner [23] OperatorId OPTIONAL, -- Tag 'B7'}

\hspace{0.75cm} \textit{profilePolicyRules [25] PprIds OPTIONAL -- Tag '99'}
...
\hspace{0.75cm} \textit{transactionId [0] TransactionId, -- The TransactionID generated by the SM-DP+}

\hspace{0.75cm} \textit{ccRequiredFlag BOOLEAN, -- Indicates if the Confirmation Code is required}

\hspace{0.75cm} \textit{bppEuiccOtpk [APPLICATION 73] OCTET STRING OPTIONAL -- otPK.EUICC.ECKA}
...
\textit{PrepareDownloadResponse ::= [33] CHOICE \{ -- Tag 'BF21'}
...
\hspace{0.75cm} \textit{euiccSigned2 EUICCSigned2, -- Signed information}

\hspace{0.75cm} \textit{euiccSignature2 [APPLICATION 55] OCTET STRING -- tag '5F37'}
...
\hspace{0.75cm} \textit{euiccOtpk [APPLICATION 73] OCTET STRING, -- otPK.EUICC.ECKA, tag '5F49'}

\hspace{0.75cm} \textit{hashCc Octet32 OPTIONAL -- Hash of confirmation code}
...
\textit{BoundProfilePackage ::= [54] SEQUENCE \{ -- Tag 'BF36'}

\hspace{0.75cm} \textit{initialiseSecureChannelRequest [35] InitialiseSecureChannelRequest, -- Tag 'BF23'}

\hspace{0.75cm} \textit{firstSequenceOf87 [0] SEQUENCE OF [7] OCTET STRING, -- sequence if '87' TLVs}

\hspace{0.75cm} \textit{sequenceOf88 [1] SEQUENCE OF [8] OCTET STRING, -- sequence of '88' TLVs}

\hspace{0.75cm} \textit{secondSequenceOf87 [2] SEQUENCE OF [7] OCTET STRING OPTIONAL,}

\hspace{0.75cm} \textit{sequenceOf86 [3] SEQUENCE OF [6] OCTET STRING, -- sequence of '86' TLVs}
...
\hspace{0.75cm} \textit{profileInstallationResult [55] ProfileInstallationResult, -- Tag 'BF37'}
...
\hspace{0.75cm} \textit{euiccNotificationSignature [APPLICATION 55] OCTET STRING, -- eUICC signature}

\hspace{0.75cm} \textit{euiccCertificate Certificate, -- CERT.EUICC.ECDSA}

\hspace{0.75cm} \textit{eumCertificate Certificate -- CERT.EUM.ECDSA}

\textit{\}\\}

\textit{ProfileInstallationResult ::= [55] SEQUENCE \{ -- Tag 'BF37'}
...
\textit{ProfileInstallationResultData ::= [39] SEQUENCE \{ -- Tag 'BF27'}

\hspace{0.75cm} \textit{transactionId[0] TransactionId, -- The TransactionID generated by the SM-DP+}

\hspace{0.75cm} \textit{notificationMetadata [47] NotificationMetadata,}

\hspace{0.75cm} \textit{smdpOid OBJECT IDENTIFIER, -- SM-DP+ OID}
...
\hspace{0.75cm} \textit{aid [APPLICATION 15] OCTET STRING (SIZE (5..16)), -- AID of ISD-P}

\hspace{0.75cm} \textit{simaResponse OCTET STRING -- contains (multiple) 'EUICCResponse'}
...
\hspace{0.75cm} \textit{simaResponse OCTET STRING OPTIONAL -- contains (multiple) 'EUICCResponse'}
