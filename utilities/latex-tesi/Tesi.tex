...
[TODO: partire dalla definizione dei casi di test per poi elencare (forse con un itemize) le risposte dei server raggruppandole per caso di test e non per server]
