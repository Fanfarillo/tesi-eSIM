...
\begin{itemize}
\item \textbf{authenticateServerResponse}: è una struttura dati complessa che verrà approfondita tra poco;
...
\end{figure}
Il JSON del payload è composto da [TODO].
