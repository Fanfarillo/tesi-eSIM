...
\hspace{1cm} \textit{svn [2] VersionType, -- GSMA SGP.22 version supported (SVN)}

\hspace{1cm} \textit{euiccCiPKIdListForVerification [9] SEQUENCE OF SubjectKeyIdentifier,}

\hspace{1cm} \textit{euiccCiPKIdListForSigning [10] SEQUENCE OF SubjectKeyIdentifier}
